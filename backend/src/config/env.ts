...
export const env = {
  ...
  NICE_SEL_USUARIO: process.env.NICE_SEL_USUARIO || '#LoginName',
  NICE_SEL_CLAVE: process.env.NICE_SEL_CLAVE || '#LoginPassword',
  NICE_SEL_BTN_LOGIN: process.env.NICE_SEL_BTN_LOGIN || '#loginButton',
  NICE_SEL_ENLACE_CATALOGO: process.env.NICE_SEL_ENLACE_CATALOGO || 'a[href*=catalogo]',
  NICE_SEL_FILA: process.env.NICE_SEL_FILA || 'div.product-card',
  NICE_SEL_SKU: process.env.NICE_SEL_SKU || 'a[href*="sItemSecondCode"]',
  NICE_SEL_NOMBRE: process.env.NICE_SEL_NOMBRE || '.text-center.mt-2',
  NICE_SEL_PRECIO: process.env.NICE_SEL_PRECIO || 'div.text-center.mt-2 h6:last-child',
  NICE_SEL_IMAGEN: process.env.NICE_SEL_IMAGEN || 'a img',
